...
#ifndef RSU_JoinAtBack_H_
#define RSU_JoinAtBack_H_
...
class RSU_JoinAtBack : public RSU_JoinManeuver {
...
public:
     ...
     */
    RSU_JoinAtBack(GeneralPlatooningApp* app){
        sendJoinPlatoonResponse_1 = nullptr;

        }        
    virtual ~RSU_JoinAtBack(){};
    ...
    virtual void handlePlatoonInfo(const PlatoonInfo* msg) override;
    ...
    virtual void sendJoinPlatoonResponse() ;
    virtual void handleSelfMsg(cMessage* msg) ;

protected:
    cMessage* sendJoinPlatoonResponse_1;
    /** Possible states a vehicle can be in during a join maneuver */
    enum class RSU_JoinManeuverState {
    ...
    RSU_JoinManeuverState RSU_joinManeuverState;
