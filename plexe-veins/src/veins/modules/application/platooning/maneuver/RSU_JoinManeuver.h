...
#ifndef RSU_JOINMANEUVER_H_
#define RSU_JOINMANEUVER_H_
...
struct RSU_JoinManeuverParameters {
    int platoonId;
    int leaderId;
    int position;
};

class RSU_JoinManeuver : public Maneuver {
...
public:
     ...
     */
    RSU_JoinManeuver(GeneralPlatooningApp* app);
    virtual ~RSU_JoinManeuver(){};
...
protected:
    ...
    RequestPlatoonInfo* createRequestPlatoonInfo(int vehicleId, std::string externalId, int platoonId, int destinationId, bool request);


    SendMTP* createSendMTP(int vehicleId, std::string externalId, int platoonId, int destinationId, bool permitted);
    ...
    virtual void handlePlatoonInfo(const PlatoonInfo* msg) = 0;
