...
void JoinTrafficManager::insertNodes1()
{
  ...
  /*  float ln0 [][3] = {{110, 120, 1}, {55,120,2}, {5, 130, 3}};
    ...
    */
    ...
    float ln0 [][3] = {}; 
    float ln1 [][3] = {{400,100,3},{390,100,3},{380,100,3},{370,100,3},{360,100,3},{350,100,3},{340,100,3},{330,100,3}};
    float ln2 [][3] = {{1000,100,3},{990,100,3},{980,100,3},{970,100,3},{960,100,3},{950,100,3},{940,100,93}};
    float ln3 [][3] = {};
    float ln4 [][3] = {{200,120,3},{190,120,3},{180,120,3},{170,120,3}};
    float ln5 [][3] = {};
